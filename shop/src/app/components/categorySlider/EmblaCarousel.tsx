...
export const EmblaCarousel: React.FC<PropType> = (props) => {
  ...
  return (
    <div className="embla-wrap">
      <div className="embla">
        <p className='category-label'>Лучшие продажи</p>
              ...
              <div className="embla__slide" key={index}>
                <div className="product-section-info">
                  ...
                  <div className="product-desc-wrap">
                    <p className="product-name">Hui</p>
                    <p className="product-price">1920$</p>
                  </div>
        ...
        <button className="catalog-btn">Go to catalog</button>
      </div>
    </div>
  )
}
